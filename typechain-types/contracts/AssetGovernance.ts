...
export interface AssetGovernanceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export namespace VotingDelayUpdatedEvent {
...
export interface AssetGovernance extends BaseContract {
  connect(runner?: ContractRunner | null): AssetGovernance;
  waitForDeployment(): Promise<this>;

  interface: AssetGovernanceInterface;
  ...
  >;
  getEvent(
    key: "VotingDelayUpdated"
  ): TypedContractEvent<
    VotingDelayUpdatedEvent.InputTuple,
    VotingDelayUpdatedEvent.OutputTuple,
    VotingDelayUpdatedEvent.OutputObject
  >;
  getEvent(
    key: "VotingPeriodSet"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "VotingDelayUpdated(uint256,uint256)": TypedContractEvent<
      VotingDelayUpdatedEvent.InputTuple,
      VotingDelayUpdatedEvent.OutputTuple,
      VotingDelayUpdatedEvent.OutputObject
    >;
    VotingDelayUpdated: TypedContractEvent<
      VotingDelayUpdatedEvent.InputTuple,
      VotingDelayUpdatedEvent.OutputTuple,
      VotingDelayUpdatedEvent.OutputObject
    >;
