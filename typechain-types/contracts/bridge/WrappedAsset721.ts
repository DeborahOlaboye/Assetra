...
export interface WrappedAsset721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface WrappedAsset721 extends BaseContract {
  connect(runner?: ContractRunner | null): WrappedAsset721;
  waitForDeployment(): Promise<this>;

  interface: WrappedAsset721Interface;
